...
def create_custom_fields():
    custom_fields = {
        ...
        "Event": [
            ...
            {
                "fieldname": "custom_stel_calendar_id",
                "label": "STEL Calendar ID",
                "fieldtype": "Data",
                "insert_after": "custom_assigned_employee",
                "read_only": 1,
                "no_copy": 1,
            },
            {
                "fieldname": "custom_planning_status",
                "label": "Planning Status",
                "fieldtype": "Select",
                "options": "Unplanned\nPlanned\nCompleted",
                "insert_after": "custom_stel_calendar_id",
                "default": "Unplanned",
                "no_copy": 1,
            },
            {
                "fieldname": "custom_estimated_duration",
                "label": "Estimated Duration (hours)",
                "fieldtype": "Float",
                "insert_after": "custom_planning_status",
                "default": "1",
                "no_copy": 1,
            },
            {
                ...
                "label": "STEL Last Sync",
                "fieldtype": "Datetime",
                "insert_after": "custom_estimated_duration",
                "read_only": 1,
                "no_copy": 1,
            },
            {
